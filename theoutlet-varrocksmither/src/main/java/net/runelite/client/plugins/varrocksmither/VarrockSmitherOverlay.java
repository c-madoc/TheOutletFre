...
@Slf4j
@Singleton
class VarrockSmitherOverlay extends OverlayPanel {
    private final VarrockSmitherPlugin plugin;
    private final VarrockSmitherConfig config;

    String timeFormat;

    @Inject
    private VarrockSmitherOverlay(final VarrockSmitherPlugin plugin, final VarrockSmitherConfig config) {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        tableComponent.addRow("Status:", VarrockSmitherPlugin.status);
