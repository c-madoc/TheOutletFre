...
@Slf4j
@Singleton
class TOFiremakerOverlay extends OverlayPanel {
    private final TOFiremakerPlugin plugin;
    private final TOFiremakerConfig config;

    String timeFormat;

    @Inject
    private TOFiremakerOverlay(final TOFiremakerPlugin plugin, final TOFiremakerConfig config) {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        tableComponent.addRow("Status:", TOFiremakerPlugin.status);
